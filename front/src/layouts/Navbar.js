...
import { faPhoneAlt, faEnvelope, faMapMarkerAlt, faBars, faTimes } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className={"left-side"}>
      <div className="mobile-bar">
        ...
        <div>
          <FontAwesomeIcon icon={value === 'close' ? faBars : faTimes} onClick={() => setValue(value === 'close' ? 'open' : 'close')}/>
        </div>
      </div>
      <div className={`mobile-block ${value}`}>
